...
<div class="jumbotron">
  <h1 style="font-family:黑体" >购物车</h1>
  <p>反应用户选择的书籍信息</p>
</div>
	<center>
		
		<div  class="row"  id="bookNumber">您的购物车中共有 ${sessionScope.ShoppingCart.bookNumber } 本书</div>
       ...
       <th>操作</th>
			...
			<tr>
				<td colspan="4">
					...
					<a href="bookServlet?method=clear" class="btn btn-default">清空购物车</a>
					&nbsp;&nbsp;
					
					<a href="bookServlet?method=forwardPage&page=cash" class="btn btn-default">结账</a>
					&nbsp;&nbsp;
				</td>
			</tr>
